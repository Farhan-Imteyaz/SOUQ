...
import { Globe, Plus, Clock, Truck, CheckCircle, XCircle } from 'lucide-react';
...
export default function InternationalShipmentDashboard() {
    ...
    <div className="p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-gray-900">International Shipment</h1>
            </div>
            <p className="text-gray-600">Ship your packages worldwide</p>
          </div>
          <Link
            href="/dashboard/international-shipment/create-order"
            className="flex items-center gap-2 px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-semibold transition-colors"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6 text-center">
          ...
          <div className="text-3xl font-bold text-purple-600 mb-2">{orderStats.currentOrders}</div>
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6 text-center">
          ...
          <div className="text-3xl font-bold text-blue-600 mb-2">{orderStats.ordersInShipment}</div>
          <p className="text-sm text-gray-500">No. of Orders</p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border p-6">
        <h2 className="text-xl font-bold text-gray-900 mb-6">Recent International Shipments</h2>
        
        {/* Empty State */}
        <div className="text-center py-12">
          <Globe className="h-16 w-16 text-gray-400 mx-auto mb-4" />
          <h3 className="text-lg font-semibold text-gray-900 mb-2">No international shipments yet</h3>
          <p className="text-gray-600 mb-6">Start shipping your packages worldwide</p>
          <Link
            href="/dashboard/international-shipment/create-order"
