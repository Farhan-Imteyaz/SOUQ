      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-32">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="bg-gradient-to-br from-purple-50 to-pink-100 p-12 rounded-2xl">
                  <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <Box className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <Warehouse className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                    <div>
              ...
              <div className="order-1 md:order-2">
                <div className="bg-gradient-to-br from-green-50 to-emerald-100 p-12 rounded-2xl">
                  <div className="bg-white p-8 rounded-xl shadow-lg">
          ...
          <div className="mb-20">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="bg-gradient-to-br from-orange-50 to-red-100 p-12 rounded-2xl">
                  <div className="bg-white p-8 rounded-xl shadow-lg">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        <div className="h-8 w-8 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0 animate-pulse">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <Plane className="h-6 w-6 text-orange-600 mt-1 flex-shrink-0" />
                    <div>
