...
const OrderDetails = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border p-6">
      ...
      {open && selectedItem && (
        <div className="fixed inset-0 flex justify-self-auto items-center w-full h-full bg-black/60">
          <div className="max-w-4xl mx-auto border rounded-xl p-6 bg-white shadow">
            <div className="mb-4">
